...
$(document).ready(function () {
    ...
    var showRulesSrc = Rx.Observable.fromEvent(showRules, 'click');
    var showRulesSub = showRulesSrc.subscribe( function () {
    ...
    var hideRulesSrc = Rx.Observable.fromEvent(hideRules, 'click');
    var hideRulesSub = hideRulesSrc.subscribe( function () {
        $("#rules").html("");
        $("#hideRules").hide();
        $("#showRules").show();
        $("#left").show();
    ...
    var top = $('#top');
    var topSrc = Rx.Observable.fromEvent(top, 'click');
    var topSub = topSrc.subscribe( function () {
