...
/* package wai-app-static-3.0.0.3 */
#define VERSION_wai_app_static "3.0.0.3"
#define MIN_VERSION_wai_app_static(major1,major2,minor) (\
  (major1) <  3 || \
  (major1) == 3 && (major2) <  0 || \
  (major1) == 3 && (major2) == 0 && (minor) <= 0)

/* package wai-websockets-3.0.0.3 */
#define VERSION_wai_websockets "3.0.0.3"
...
/* package websockets-0.9.2.1 */
#define VERSION_websockets "0.9.2.1"
